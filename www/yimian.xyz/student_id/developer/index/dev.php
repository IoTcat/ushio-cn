	...
	<div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
            <ul class="nav sidebar-nav">
                ...
                <li>
                    <a href="dev.php"><i class="fa fa-fw fa-home"></i> 未完成</a>
                </li>
                <li>
                    <a href="dev_post.php"><i class="fa fa-fw fa-folder"></i> 已完成</a>
                </li>
                <li>
                    <a href="../index/index.php"><i class="fa fa-fw fa-folder"></i> </a>
                </li>
            </ul>
        </nav>
        <!-- /#sidebar-wrapper -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        ...
                        <h1 class="page-header">前端项目模块</h1>  <p class="lead">
                        <?php
$servername = "localhost";
$username = "steel";
$password = "151515";
...
?></p>
						                    ...
						                    <h1 class="page-header">后端项目模块</h1>  <p class="lead">
                        <?php
$servername = "localhost";
$username = "steel";
$password = "151515";
...
$sql = "SELECT * FROM bug where host='15'";
$result = $conn->query($sql);
