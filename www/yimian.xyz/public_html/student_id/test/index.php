...
if($id=='1717888'){}
else{echo "<script>alert('ID不存在！');window.location.href='https://www.baidu.com';</script>";};
?>
...
<section class="logo-license">
    ...
    <div class="half">
        <div class="uploader blue">
            ...
            <a class="license">
                <img id="img-1" src="images/user.jpg"/>
            </a>
...
<article class="btn-1">
    <button onclick="window.history.back(-1)">返回 Back</button>
</article>
